function [boundaryIndices, elements, p, F, coupling] = solveForwardMultiLevel(c, omega, gamma, waveNumber, center, radii, sourceValues, domain, N)
...
excitation = 1/(2*max(sourceValues))*ones(n,1); %constant excitation?
