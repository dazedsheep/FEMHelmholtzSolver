...
% array
source = omega^2./(speed_of_sound.^2 + 1i .* omega .* diffusivity).*createPointSourceWithAngles(elements, excitationPoints, meshSize, angles).*referencePressure;  
