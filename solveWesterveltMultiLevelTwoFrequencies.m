function [i, u, F] = solveWesterveltMultiLevelTwoFrequencies(elements, omega, beta, gamma, kappa, excitation, f, nHarmonics, minHarmonics, scaleBoundaryCondition, threshold)
%% This is a multi-threaded version of the Westervelt solver for two fundamental frequencies

% pre-alloc everything for the Helmholtz conforming FEM solver
...
% this is now an fundamental frequencies x iterations x harmonics x
% elements; matrix; for now we live with the memory it eats up (esp. the
% iterations)
u = zeros(N,N,n);
