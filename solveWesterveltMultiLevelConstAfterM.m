function [i, u, F] = solveWesterveltMultiLevelConstAfterM(elements, omega, beta, gamma, kappa, excitation, f, nHarmonics,M, minHarmonics, scaleBoundaryCondition, threshold)
...
elapsedTime = -1;
for i=1:N
    % set all harmonics above M to zero
